    ...
    [
        ...
        (
            ...
            [(Name.Class, '<モデル>'),
             ...
             (Whitespace, ' '),
             (Whitespace, ' '),
             (Name.Variable.Instance, '<プロパティの名前>'),
             (Whitespace, ' '),
             (Punctuation, ':'),
             (Whitespace, ' '),
             (Keyword.Type, '<プロパティの型>'),
             (Whitespace, ' '),
             (Punctuation, ';'),
             (Punctuation, '}'),
             (Whitespace, ' '),
             (Operator, '+'),
             (Whitespace, ' '),
             (Name.Variable.Instance, '<合成するモデル>'),
             (Whitespace, ' '),
             (Operator, '+'),
             (Whitespace, ' '),
             (Punctuation, '{'),
        ...
        (
            'summarized <集計モデル名> = <対象モデル1> => {'
            '    <集約関数> <集約対象のプロパティ名> -> <集約結果のプロパティ名> ;'
            '} % <グループ化キー>;',
            [(Keyword.Type, 'summarized'),
             (Whitespace, ' '),
             (Name.Class, '<集計モデル名>'),
             ...
             (Name.Function, '<集約関数>'),
             (Whitespace, ' '),
             (Name.Variable.Instance, '<集約対象のプロパティ名>'),
             (Whitespace, ' '),
             (Operator, '->'),
             (Whitespace, ' '),
             (Name.Variable.Instance, '<集約結果のプロパティ名>'),
             (Whitespace, ' '),
             (Punctuation, ';'),
             (Punctuation, '}'),
             (Whitespace, ' '),
